...
public class PedidoService {
    ...
    @Transactional
    public void salvarPedido(Pedido pedido){pedidoRepository.save(pedido);}

    @Transactional
    public void alterarPedido(Pedido pedido){pedidoRepository.save(pedido);}

    public List<Pedido> listarPedidos(int id){ return pedidoRepository.listarPedidosPorUsuario(id);}
